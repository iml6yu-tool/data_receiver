...
namespace iml6yu.DataReceive.ModbusMasterTCP
{
    public static class DataReceiverModbusTCPExtension
    {
        ...
        public static IServiceCollection AddReceiver(this IServiceCollection services, DataReceiverModbusTCPOption option, bool isAutoLoadNodeConfig = false, List<NodeItem> nodes = null)
